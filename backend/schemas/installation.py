...
class InstallationRequest(BaseModel):
    ...
    prop_nls_length_semantics: Optional[str] = Field(default=None, description="NLS_LENGTH_SEMANTICS")
    prop_analyst_data_source: Optional[str] = Field(default=None, description="ANALYST_DATA_SOURCE")
    prop_miner_data_source: Optional[str] = Field(default=None, description="MINER_DATA_SOURCE")
    prop_fsdf_upload_model: Optional[str] = Field(default=None, description="FSDF_UPLOAD_MODEL (0/1)")
    prop_amlsource: Optional[str] = Field(default=None, description="AMLSOURCE")
    prop_kycsource: Optional[str] = Field(default=None, description="KYCSOURCE")
    prop_cssource: Optional[str] = Field(default=None, description="CSSOURCE")
    prop_externalsystemsource: Optional[str] = Field(default=None, description="EXTERNALSYSTEMSOURCE")
    prop_tbamlsource: Optional[str] = Field(default=None, description="TBAMLSOURCE")
    prop_fatcasource: Optional[str] = Field(default=None, description="FATCASOURCE")
    prop_ofsecm_datasrcname: Optional[str] = Field(default=None, description="OFSECM_DATASRCNAME")
    prop_comn_gateway_ds: Optional[str] = Field(default=None, description="COMN_GATWAY_DS")
    prop_t2jurl: Optional[str] = Field(default=None, description="T2JURL")
    prop_j2turl: Optional[str] = Field(default=None, description="J2TURL")
    prop_cmngtwyurl: Optional[str] = Field(default=None, description="CMNGTWYURL")
    prop_bdurl: Optional[str] = Field(default=None, description="BDURL")
    prop_ofss_wls_url: Optional[str] = Field(default=None, description="OFSS_WLS_URL")
    prop_aai_url: Optional[str] = Field(default=None, description="AAI_URL")
    prop_cs_url: Optional[str] = Field(default=None, description="CS_URL")
    prop_arachnys_nns_service_url: Optional[str] = Field(default=None, description="ARACHNYS_NNS_SERVICE_URL")
