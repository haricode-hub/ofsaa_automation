...
async def run_installation_process(task_id: str, request: InstallationRequest):
    ...
    try:
        ...
        cfg_result = await installation_service.apply_installer_config_files(
            ...
            prop_amlsource=request.prop_amlsource,
            prop_kycsource=request.prop_kycsource,
            prop_cssource=request.prop_cssource,
            prop_externalsystemsource=request.prop_externalsystemsource,
            prop_tbamlsource=request.prop_tbamlsource,
            prop_fatcasource=request.prop_fatcasource,
            prop_ofsecm_datasrcname=request.prop_ofsecm_datasrcname,
            prop_comn_gateway_ds=request.prop_comn_gateway_ds,
            prop_t2jurl=request.prop_t2jurl,
            prop_j2turl=request.prop_j2turl,
            prop_cmngtwyurl=request.prop_cmngtwyurl,
            prop_bdurl=request.prop_bdurl,
            prop_ofss_wls_url=request.prop_ofss_wls_url,
            prop_aai_url=request.prop_aai_url,
            prop_cs_url=request.prop_cs_url,
            prop_arachnys_nns_service_url=request.prop_arachnys_nns_service_url,
