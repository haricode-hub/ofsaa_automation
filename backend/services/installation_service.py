    ...
    async def apply_installer_config_files(
        ...
        *,
        ...
        return await self.installer.apply_config_files_from_repo(
            ...
            prop_amlsource=prop_amlsource,
            prop_kycsource=prop_kycsource,
            prop_cssource=prop_cssource,
            prop_externalsystemsource=prop_externalsystemsource,
            prop_tbamlsource=prop_tbamlsource,
            prop_fatcasource=prop_fatcasource,
            prop_ofsecm_datasrcname=prop_ofsecm_datasrcname,
            prop_comn_gateway_ds=prop_comn_gateway_ds,
            prop_t2jurl=prop_t2jurl,
            prop_j2turl=prop_j2turl,
            prop_cmngtwyurl=prop_cmngtwyurl,
            prop_bdurl=prop_bdurl,
            prop_ofss_wls_url=prop_ofss_wls_url,
            prop_aai_url=prop_aai_url,
            prop_cs_url=prop_cs_url,
            prop_arachnys_nns_service_url=prop_arachnys_nns_service_url,
